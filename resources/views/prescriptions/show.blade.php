...
<style>
    ...
    .form-grid-rx-full { margin-bottom: 14px; }

    .fl { font-size: 12px; font-weight: 600; color: #64748b;
    ...
    .fi:focus { border-color: #1363C6; background: #fff; box-shadow: 0 0 0 3px rgba(19,99,198,0.08); }
    ...
    .btn-edit:hover { background: #dbeafe; color: #1363C6; }
        ...
        <div class="rx-body">
            <div class="booking-meta">
                ...
                <div class="meta-item">
                    ...
                    <div class="meta-value" style="font-family:monospace;color:#1363C6">{{ $booking->action_token }}</div>
                </div>
                <div class="meta-item">
                            ...
                            <tr>
                                ...
                                <td style="white-space:nowrap">
                                    <button class="btn-edit me-1"
                                            onclick="openEdit({{ $rx->id }}, '{{ addslashes($rx->medicine_name) }}', '{{ addslashes($rx->dosage) }}', '{{ addslashes($rx->frequency) }}', '{{ addslashes($rx->duration) }}', '{{ addslashes($rx->instructions) }}')">
                                        Edit
                                    </button>
                                    <form method="POST"
...
<div class="modal-backdrop-rx" id="editModal">
    <div class="modal-box">
        ...
        <form method="POST" id="editForm">
            @csrf @method('PUT')
            <div class="form-grid-rx" style="grid-template-columns:1fr 1fr;margin-bottom:14px">
                <div>
